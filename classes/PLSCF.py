...
class PLSCF(ModalBase):
    ...
    def init_from_config(cls,conf_file, prep_data):
        ...
        pLSCF_object.build_half_spectra(begin_frequency, end_frequency, nperseg)
    ...
    def build_half_spectra(self, begin_frequency, end_frequency, nperseg):
        ...
        roving_channels = [i for i in range(self.prep_data.num_analised_channels) if i not in ref_channels]
        ...
        for ii in range(num_ref_channels):
            ...
            for jj in range(num_analised_channels):
                ...
                frequency_vector, this_half_spec = scipy.signal.welch(R_xy, fs=sampling_rate, window='boxcar', \
